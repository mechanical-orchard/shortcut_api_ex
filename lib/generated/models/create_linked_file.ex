defmodule Generated.Models.CreateLinkedFile do
  @moduledoc """
  Generated struct for CreateLinkedFile
  """
  ...
  defstruct [:content_type, :description, :name, :size, :story_id, :thumbnail_url, :type, :uploader_id, :url]
