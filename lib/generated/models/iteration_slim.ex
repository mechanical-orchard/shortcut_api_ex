defmodule Generated.Models.IterationSlim do
  @moduledoc """
  ...
  defstruct [:app_url, :associated_groups, :created_at, :end_date, :entity_type, :follower_ids, :global_id, :group_ids, :group_mention_ids, :id, :label_ids, :labels, :member_mention_ids, :mention_ids, :name, :start_date, :stats, :status, :updated_at]
