defmodule Generated.Models.UpdateGroup do
  @moduledoc """
  Generated struct for UpdateGroup
  """
  ...
  defstruct [:archived, :color, :color_key, :description, :display_icon_id, :member_ids, :mention_name, :name, :workflow_ids]
