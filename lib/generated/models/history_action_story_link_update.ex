defmodule Generated.Models.HistoryActionStoryLinkUpdate do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    action: String.t(),
        changes: Generated.Models.HistoryChangesStoryLink.t(),
  ...
  defstruct [:action, :changes, :entity_type, :id, :object_id, :subject_id, :verb]
