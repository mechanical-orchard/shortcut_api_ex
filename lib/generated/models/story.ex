defmodule Generated.Models.Story do
  @moduledoc """
  ...
  defstruct [:requested_by_id, :group_mention_ids, :created_at, :entity_type, :started_at, :archived, :custom_fields, :lead_time, :mention_ids, :completed_at, :deadline, :files, :commits, :project_id, :external_links, :workflow_state_id, :labels, :external_id, :owner_ids, :label_ids, :estimate, :comments, :blocked, :story_links, :iteration_id, :story_template_id, :started_at_override, :story_type, :id, :name, :description, :moved_at, :updated_at, :epic_id, :pull_requests, :tasks, :linked_files, :synced_item, :blocker, :workflow_id, :member_mention_ids, :previous_iteration_ids, :position, :completed_at_override, :completed, :global_id, :follower_ids, :started, :unresolved_blocker_comments, :group_id, :branches, :stats, :app_url, :cycle_time]
