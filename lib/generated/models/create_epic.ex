defmodule Generated.Models.CreateEpic do
  @moduledoc """
  Generated struct for CreateEpic
  """
  ...
  defstruct [:completed_at_override, :created_at, :deadline, :description, :epic_state_id, :external_id, :follower_ids, :group_id, :group_ids, :labels, :milestone_id, :name, :objective_ids, :owner_ids, :planned_start_date, :requested_by_id, :started_at_override, :state, :updated_at]
