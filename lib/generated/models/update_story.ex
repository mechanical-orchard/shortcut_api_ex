defmodule Generated.Models.UpdateStory do
  @moduledoc """
  Generated struct for UpdateStory
  """
  ...
  defstruct [:after_id, :archived, :before_id, :branch_ids, :commit_ids, :completed_at_override, :custom_fields, :deadline, :description, :epic_id, :estimate, :external_links, :file_ids, :follower_ids, :group_id, :iteration_id, :labels, :linked_file_ids, :move_to, :name, :owner_ids, :project_id, :pull_request_ids, :requested_by_id, :started_at_override, :story_type, :workflow_state_id]
...
"""
def pull_request_ids(%__MODULE__{pull_request_ids: value}), do: value
